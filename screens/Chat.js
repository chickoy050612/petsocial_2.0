...
import { View, Text, TextInput, FlatList, KeyboardAvoidingView, TouchableOpacity, Image } from 'react-native';
...
class Chat extends React.Component {
  ...
  render() {
    ...
    //alert('Chat.js uid:' + uid + " params " + JSON.stringify(params))
      ...
      <KeyboardAvoidingView enabled behavior='padding' style={styles.container}>
        <FlatList
          ...
          <TouchableOpacity style={[styles.row, styles.space]}>
            ...
            <View style={[ item.uid === uid ? styles.right : styles.left]}>
